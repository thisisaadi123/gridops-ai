export const DEMO_RESULT = {
  ...
  trading_mandate: {
    ...
    rationale: [
      ...
      'The Anomaly Severity Score combines three independent signals into a single 0-to-1 risk indicator. It serves as the master decision signal for whether to take operational action. The final severity score is 0.22. Since this score is below the 0.40 action threshold, no reserve deployment is warranted.',
